...
class ReceiveConnectionStateUseCase @Inject constructor(
    private val roomRepository: RoomRepository,
) {
    suspend operator fun invoke(): Flow<TogeResult<ConnectionState>> =
        roomRepository.receiveConnectionState()
}