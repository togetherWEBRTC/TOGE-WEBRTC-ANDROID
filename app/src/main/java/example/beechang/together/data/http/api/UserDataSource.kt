...
interface UserDataSource {
    ...
    suspend fun modifyProfileImage(): TogeResult<ModifyUserInfoResponse>
    suspend fun modifyNickname(modifyNicknameRequest: ModifyNicknameRequest): TogeResult<ModifyUserInfoResponse>
